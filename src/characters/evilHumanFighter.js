/**
 * Evil Human Fighter Character Data
 * @description Character data for the Evil Human Fighter (same as Human Fighter but evil)
 */

export const evilHumanFighter = {
  'name': 'Evil Human Fighter',
  'slug': 'evil-human-fighter',
  'description': 'Evil human with sword and shield',
  'health': '12',
  'firstMove': '62',
  'weapon': true,
  'shield': true,
